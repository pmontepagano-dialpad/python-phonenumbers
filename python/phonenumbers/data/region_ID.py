...
PHONE_METADATA_ID = PhoneMetadata(id='ID', country_code=62, international_prefix='0(?:0[1789]|10(?:00|1[67]))',
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='177\\d{6,8}|800\\d{5,7}|7803\\d{7}', example_number='8001234567', possible_length=(8, 9, 10, 11)),
