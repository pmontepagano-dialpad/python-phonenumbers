...
PHONE_METADATA_VN = PhoneMetadata(id='VN', country_code=84, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='2(?:0[3-9]|1[0-689]|2[0-25-9]|3[2-9]|4[2-8]|5[124-9]|6[0-39]|7[0-7]|8[2-7]|9[0-4679])\\d{7}', example_number='2101234567', possible_length=(9, 10)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:1(?:2\\d|6[2-9]|8[68]|99)\\d|8(?:6[689]|8\\d|9[89])|9(?:[0-8]\\d|9[013-9]))\\d{6}', example_number='912345678', possible_length=(9, 10)),
    ...
    number_format=[NumberFormat(pattern='([17]99)(\\d{4})', format='\\1 \\2', leading_digits_pattern=['[17]99'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(86[689])(\\d{3})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['86[689]'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
